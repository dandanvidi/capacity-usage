...
legend = plt.legend(scatterpoints=1,bbox_to_anchor=(1.65, 1.022))
...
ax.grid()
#plt.tight_layout()
plt.savefig('../res/functional concentration by gr.png',bbox_extra_artists=(legend,), bbox_inches='tight')
